...
function IsBooleanOrString(validationOptions) {
    return (0, simpleValidatorFactory_1.validatorFactory)((value) => (0, class_validator_1.isInt)(value) || (0, class_validator_1.isMongoId)(value))((0, lodash_1.merge)(validationOptions || {}, {
